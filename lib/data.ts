...
export const leadership = {
  ...
  cLevel: [
    { name: 'Камилла Каюмова', role: 'COO (Операционный директор)', area: 'Операции, HR, Китай, ВЭД, Развитие, Маркетинг, IT' },
    ...
    teams: [
      {
        id: 'china-1',
        name: 'Группа Артёма',
        lead: { name: 'Артём', role: 'РГ' },
        members: [
          { name: 'Светлана', role: 'Менеджер по проектам' },
          { name: 'Киселёва', role: 'Менеджер по закупкам' },
          { name: 'Алёна', role: 'Менеджер по закупкам' },
        ],
      },
      {
        id: 'china-2',
        name: 'Группа Евгения',
        lead: { name: 'Евгений', role: 'РГ' },
        members: [
          { name: 'Фёдор', role: 'Менеджер по закупкам' },
          { name: 'Екатерина', role: 'Менеджер по закупкам' },
          { name: 'Виктория', role: 'Менеджер по закупкам' },
          { name: 'Мария', role: 'Менеджер по проектам' },
          { name: 'Марина', role: 'Менеджер по закупкам' },
          { name: 'Анастасия', role: 'Менеджер по закупкам' },
        ],
      },
      {
        id: 'china-3',
        name: 'Группа Александры',
        lead: { name: 'Александра', role: 'РГ' },
        members: [
          { name: 'Дарья', role: 'Менеджер по закупкам' },
          { name: 'Анастасия', role: 'Менеджер по проектам' },
        ],
      },
      {
        id: 'china-4',
        name: 'Группа Насти А.',
        lead: { name: 'Анастасия', role: 'РГ' },
        members: [
          { name: 'Светлана', role: 'Менеджер по проектам' },
          { name: 'Елена', role: 'Менеджер по закупкам' },
          { name: 'Чаплыгина', role: 'Менеджер по закупкам' },
        ],
      },
      {
        id: 'china-5',
        name: 'Группа Юлии',
        lead: { name: 'Юлия', role: 'РГ' },
        members: [],
      },
      {
        id: 'china-6',
        name: 'Группа Сергея',
        lead: { name: 'Сергей', role: 'РГ' },
        members: [],
      },
    ],
  },
